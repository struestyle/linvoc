...
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QLabel, QApplication, QGraphicsOpacityEffect
)
from PySide6.QtCore import (
    Qt, QTimer, QPropertyAnimation, QEasingCurve, Signal, Slot, QSize
)
...
class MicrophoneWidget(QWidget):
    ...
    def _update_style(self):
        ...
        self._render_svg_to_label(self._close_btn, "close", QColor(colors['text_muted']), 14)
